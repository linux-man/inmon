...
class Preferences(Gtk.Dialog):
	def __init__(self, parent, app_name, version, prefs):
		...
		self.backend_combo.append("uinput", "uinput")
		...
		l = Gtk.Label(_("For Wayland, use 'pynput-evdev' (no mouse support) or 'uinput'. You must be a member of 'input' and 'tty' groups to access /dev/input: 'sudo usermod -a -G input USERNAME' and 'sudo usermod -a -G tty USERNAME'"))
